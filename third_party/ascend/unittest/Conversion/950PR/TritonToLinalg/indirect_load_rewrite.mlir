...
// -----
// V1 rank-1 hit (AddPtr, static power-of-two stride 4):
// Debug/profiling mode routes tail-axis jumps to triton_stride_load.
...
// CHECK-NOT: call @triton_indirect_load
// CHECK: call @triton_stride_load
// CHECK-SAME: : (memref<?xf32>, i32, f32, i32, i32) -> tensor<256xf32>
module attributes {hacc.target = #hacc.target<"Ascend950PR_9579">} {
...
// The stride cannot be proven power-of-two, so route to triton_stride_load.
...
// CHECK-NOT: call @triton_indirect_load
// CHECK: call @triton_stride_load
// CHECK-SAME: : (memref<?xf32>, i32, f32, i32, i32, i32, i32) -> tensor<4x8xf32>
module attributes {hacc.target = #hacc.target<"Ascend950PR_9579">} {
...
// -----
// V1 rank-1 hit (make_tensor_ptr, static power-of-two stride 8):
...
// -----
// V2 hit (make_tensor_ptr Store, dynamic stride):
// Dynamic tail-axis store jumps route to triton_stride_store.
